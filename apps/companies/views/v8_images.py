"""companies · DESCARGAR IMÁGENES: una vista por tabla de imágenes, como «Procesar»: cuántas faltan, N o todas, en el worker
(se ve en Tareas y en Dozzle), por lotes y cancelable. Los fallos quedan en el log de la app."""
from django.utils.translation import gettext_lazy as _

from apps.companies import forms
from apps.companies.views.base import BaseCompanyImage
from apps.system import tasks as system_tasks
from core.shared.views.base import BaseImport


class CompanyImageDownloadView(BaseCompanyImage, BaseImport):
    """Descargar a disco las imágenes pendientes de compañías."""
    forms = (forms.CompanyImageDownloadForm, forms.CompanyImageRetryForm)
    source_key = "imágenes"
    source_label = _("Imágenes")
    task_procesar = system_tasks.download_images_batch_task
    title = _("Descargar imágenes de compañías")
